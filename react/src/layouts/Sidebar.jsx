...
const navItems = [
  ...
  { path: '/path-planner', label: 'AI Path Planner', icon: Milestone, color: 'blue' },
  { path: '/life-events', label: 'Life Events', icon: Sparkles, color: 'pink' },
  { path: '/couple-planner', label: 'Couple Planner', icon: Users, color: 'blue' },
